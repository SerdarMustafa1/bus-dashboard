module.exports = {
  CAMPAIGN: {
    ...
    EDIT: {
      ...
      PRIORITY: 'campaign.edit.priority', //  user1 (changer)  campaign  strValue1 (oldVal) strValue2 (newVal)
  ...
  OPERATOR: {
    EDIT: {
      ...
      VISIBLE: 'operator.edit.visible', // user1 (changer)  operator  strValue1 (oldVal) strValue2 (newVal)
    },
  },
  INSTALL: {
  ...
  INSTALLER: {
    NEW: 'installer.new', //DONE user1 (installer)  installation fleet
    EDIT: {
      TEAM: 'installer.edit.team',
      USER: 'installer.edit.user',
    },
    DELETE: 'installer.del',
    HIDE: 'installer.hide',
  },
  INSTALLORDER: {
    NEW: 'installOrder.new', // user1 (installer)  installation fleet
    EDIT: {
      COUNT: 'installOrder.edit.count', // user1 (changer)  installation  strValue1 (oldVal) strValue2 (newVal) fleet
    },
    DELETE: 'installOrder.del', // user1  strValue1 (oldVal) strValue2 (newVal) fleet
    HIDE: 'installOrder.hide', // user1  strValue1 (oldVal) strValue2 (newVal) fleet
  },
  REMOVE: {
  ...
  TEAM: {
    NEW: 'team.new', //user1 (creator)  team
    EDIT: {
      COMPANY: 'team.edit.company', //user1 (changer)  team  strValue1 (oldVal) strValue2 (newVal)
    },
    DELETE: 'team.del', //user (deleter)  team
    HIDE: 'team.hide', //user (deleter)  team
  },
  FLEET: {
    EDIT: {
